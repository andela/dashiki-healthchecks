# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2017-07-18 07:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', models.CharField(choices=[
                    ...
                    ('telegram', 'Telegram')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[
                    ...
                    ('paused', 'Paused')], default='new', max_length=6)),
                ('nag_time', models.DurationField(default=datetime.timedelta(0))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('check_obj', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.Check')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('level', models.IntegerField(choices=[(1, 'High'), (2, 'Medium'), (3, 'Low'), (0, 'None')])),
                ('status', models.CharField(choices=[
                    ('pending', 'Pending'), ('contacted', 'Contacted')], default='pending', max_length=100)),
                ('current_check', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.Check')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
